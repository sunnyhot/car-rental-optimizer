...
private let mockStores: [String: Store] = [
    "ehiTongzhou": Store(
        id: "ehi-tongzhou",
        platform: .ehi,
        name: "北京通州万达店",
        ...
        location: GeoPoint(lat: 39.909, lng: 116.657),
        distanceKm: 6.8,
        hours: "08:00-22:00"
    ),
    "ehiDezhou": Store(
    ...
    "carSouth": Store(
        ...
        city: "北京",
        address: "北京市丰台区北京南站",
        location: GeoPoint(lat: 39.865, lng: 116.379),
        distanceKm: 32,
        hours: "07:30-22:30"
    ),
    "carTongzhouCompact": Store(
        ...
        city: "北京",
        address: "北京市通州区北苑附近",
        location: GeoPoint(lat: 39.903, lng: 116.642),
        distanceKm: 4.2,
        hours: "08:00-21:00"
    )
]
    ...
    func search(request: SearchRequest) async -> [RentalListing] {
        ...
        let listings = [
            ...
            RentalListing(
                ...
                platform: .carInc,
                store: mockStores["carTongzhouCompact"]!,
